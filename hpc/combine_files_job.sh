...
# Job Information:
# Name: combine_files_job.sh 
# Description: Combine zonal stats netcdf files, export a single netcdf file 
# Python Script: combine_zonal_stats.py

#SBATCH --job-name=combine               # Name of the job
...
PYSCRIPT="../dataset_generation/combine_zonal_stats.py"
